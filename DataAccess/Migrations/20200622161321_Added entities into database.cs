...
{
    public partial class Addedentitiesintodatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillOfLadings_Loads_LoadId",
                        column: x => x.LoadId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverLoads", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillOfLadings_DriverId",
                table: "BillOfLadings",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_BillOfLadings_LoadId",
                table: "BillOfLadings",
                column: "LoadId");

            migrationBuilder.CreateIndex(
                name: "IX_DriverLoads_DriverId",
                table: "DriverLoads",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_DriverLoads_LoadId",
                table: "DriverLoads",
                column: "LoadId");
